...
A Python toolkit for scraping, processing, and converting Old Church Slavonic (OCS) texts particularly targeting the Private Use Area (PUA) into standard Unicodes. This repository contains Python scripts for handling and normalizing text.
